...
var Player = function(opts) {
	var id = opts.id,
		...
		remoteUpdatesTime = Date.now(),
		remotePlayersUpdateTime = [], // Time last update was sent for remote players
		remoteBulletsUpdateTime = []; // Time last update was sent for bullets
	...
	var getRemoteUpdatesTime = function() {
		return remoteUpdatesTime;
	}

	var clearRemoteUpdateTimes = function(time) {
		remotePlayersUpdateTime = [];
		remoteBulletsUpdateTime = [];
		remoteUpdatesTime = time;
	};

	var getRemotePlayersUpdateTime = function(id) {
		return remotePlayersUpdateTime[id];
	};

	var getRemoteBulletsUpdateTime = function(id) {
		return remoteBulletsUpdateTime[id];
	};

	var setRemotePlayersUpdateTime = function(id, time) {
		remotePlayersUpdateTime[id] = time;
	};

	var setRemoteBulletsUpdateTime = function(id, time) {
		remoteBulletsUpdateTime[id] = time;
	};
	...
	return {
		...
		bulletHit: bulletHit,
		screen: screen,
		getRemotePlayersUpdateTime: getRemotePlayersUpdateTime,
		getRemoteBulletsUpdateTime: getRemoteBulletsUpdateTime,
		setRemotePlayersUpdateTime: setRemotePlayersUpdateTime,
		setRemoteBulletsUpdateTime: setRemoteBulletsUpdateTime,
		getRemoteUpdatesTime: getRemoteUpdatesTime,
		clearRemoteUpdateTimes: clearRemoteUpdateTimes
	};
};
